...
export default function Dashboard() {
  ...
  ).map(([name, value]) => ({ name, value, color: STATUS_COLORS[name] || "#5BA4B4" }))
  ...
  ).map(([name, value]) => ({ name, value, color: LEAD_STATUS_COLORS[name] || "#5BA4B4" }))
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#5BA4B4]" />
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        {/* 1. Ventas Totales */}
        <Card className="border-t-4 border-t-[#5BA4B4]">
          <CardContent className="pt-2 pb-4 px-4">
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                <p className="text-xs text-[#5BA4B4] uppercase tracking-wide font-bold">Ventas Totales</p>
              ...
              <div className="p-2 bg-[#5BA4B4]/10 rounded-full shrink-0">
                <DollarSign className="h-4 w-4 text-[#5BA4B4]" />
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={getMonthlyData()}>
                  ...
                  <Legend />
                  <Bar dataKey="ingresos" name="Ingresos" fill="#5BA4B4" radius={[4, 4, 0, 0]} />
            ...
            <div className="space-y-4 pt-4">
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div className="bg-[#5BA4B4] h-3 rounded-full" style={{ width: "100%" }} />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
